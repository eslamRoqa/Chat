...
import {removeData} from '../components/UserDataLocal';
...
const HomeScreen = ({navigation}) => {
  ...
  console.log('ContextIdInHomeScreen', contextId);
  const value = AsyncStorage.getItem('userId').then(id => {
    console.log('userIdFromAsyncStorageInHomeScreen', id);
  });
